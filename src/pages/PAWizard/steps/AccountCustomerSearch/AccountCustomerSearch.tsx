...
export const AccountCustomerSearch = () => {
  ...
  const selectedCustomerName = selectedAccount
    ? `${selectedAccount.accountHolder?.firstName || ""} ${
        selectedAccount.accountHolder?.lastName || ""
      }`.trim()
    : "";
